...
Public Class RtItemControl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_Control.RtItemControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WhsCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRtItemControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RtItemControl = New RtItemControl()
        rpt.Site = Me.Site
        Return rpt
    End Function
